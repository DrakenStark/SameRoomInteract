...
namespace DrakenStark
{
    ...
    public class SameRoomInteract : UdonSharpBehaviour
    {
        [SerializeField] private VRC.Udon.UdonBehaviour _udonWithInteract = null;
        ...
        public void _rayCheck()
        {
            if (gameObject.activeSelf && _loopCount < 2)
            {
                ...
                _udonWithInteract.DisableInteractive = Physics.Raycast(transform.position, (_playerPos - transform.position).normalized, out RaycastHit hit, _distance, _wallLayers);
